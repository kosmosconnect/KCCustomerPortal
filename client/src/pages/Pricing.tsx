  ...
  return (
    <Root>
      ...
      <Box sx={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
        <Box sx={{ position: 'absolute', width: 600, height: 600, borderRadius: '50%', background: 'radial-gradient(circle,rgba(157,78,221,.1) 0%,transparent 70%)', top: '-10%', left: '-5%', filter: 'blur(60px)' }} />
        <Box sx={{ position: 'absolute', width: 500, height: 500, borderRadius: '50%', background: 'radial-gradient(circle,rgba(0,180,216,.08) 0%,transparent 70%)', bottom: '10%', right: '-5%', filter: 'blur(50px)' }} />
      </Box>
