          ...
          <Grid container spacing={6} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ p: 4, borderRadius: '24px', background: 'linear-gradient(135deg,rgba(157,78,221,.08),rgba(0,180,216,.06))', border: '1px solid rgba(0,180,216,.2)', textAlign: 'center' }}>
                <Box sx={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 100, height: 100, borderRadius: '50%', background: 'linear-gradient(135deg,rgba(157,78,221,.2),rgba(0,180,216,.2))', border: '2px solid rgba(0,180,216,.3)', boxShadow: '0 0 50px rgba(0,180,216,.2)', mb: 3, animation: `${float} 5s ease-in-out infinite` }}>
                  <Satellite sx={{ color: '#00B4D8', fontSize: '3rem' }} />
                </Box>
